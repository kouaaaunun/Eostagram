...
ActiveRecord::Schema.define(version: 20190830215423) do
  ...
  create_table "eventhashes", force: :cascade do |t|
    t.integer "event_id"
    t.integer "hash_tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_eventhashes_on_event_id"
    t.index ["hash_tag_id"], name: "index_eventhashes_on_hash_tag_id"
  end
